...
export default function initModels(sequelize) {
  ...
  like_res.belongsTo(appfood, { as: "re", foreignKey: "res_id" });
  appfood.hasMany(like_res, { as: "like_res", foreignKey: "res_id" });
  rate_res.belongsTo(appfood, { as: "re", foreignKey: "res_id" });
  appfood.hasMany(rate_res, { as: "rate_res", foreignKey: "res_id" });
